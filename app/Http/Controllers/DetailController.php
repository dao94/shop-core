...
class DetailController extends Controller {
	...
	*/
	...
	{		
		...
		$data           = ['news'=> $news,'list_category' => $category,'list_product_status' => $Product_status,'product_detail'=> $product_detail,'product_same'=>$product_same,'list_partner'=>$list_partner,'list_intro'=>$list_intro];
	...
	public function news($id) {
		...
		$data           = ['news'=> $news,'list_category' => $category,'list_product_status' => $Product_status,'news_detail'=>$news_detail,'list_partner'=>$list_partner,'list_intro'=>$list_intro];
